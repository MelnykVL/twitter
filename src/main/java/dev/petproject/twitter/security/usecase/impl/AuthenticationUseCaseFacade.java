...
import dev.petproject.twitter.security.usecase.AuthenticationUseCase;
...
public class AuthenticationUseCaseFacade implements AuthenticationUseCase {
  ...
  public AccessToken authenticate(LoginRequest loginRequest) {
    Authentication authenticationToken = new UsernamePasswordAuthenticationToken(loginRequest.username(),
